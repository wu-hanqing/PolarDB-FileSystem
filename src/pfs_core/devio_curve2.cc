...
static int64_t curve2_iodepth = 65536;
PFS_OPTION_REG(curve2_iodepth, pfs_check_ival_normal);
...
{
    pfs_curveioq_t *dkioq = (pfs_curveioq_t *)ioq;
    return (dkioq->dkq_inflight_count >= curve2_iodepth);
}
...
struct pfs_devops pfs_curve2dev_ops = {
    .dop_name           = "curve2",
    .dop_type           = PFS_DEV_CURVE2,
