...
ssize_t pfs_readv(int fd, const struct iovec *iov, int iovcnt);
ssize_t pfs_readv_dma(int fd, const struct iovec *iov, int iovcnt);
ssize_t	pfs_write(int fd, const void *buf, size_t len);
ssize_t pfs_write_dma(int fd, const void *buf, size_t len);
ssize_t pfs_writev(int fd, const struct iovec *iov, int iovcnt);
ssize_t pfs_writev_dma(int fd, const struct iovec *iov, int iovcnt);
...
ssize_t pfs_pwritev_dma(int fd, const struct iovec *iov, int iovcnt, off_t offset);
